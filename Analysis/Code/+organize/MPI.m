function[] = MPI(mipvar, varName)
%% Organizes MPI model output into a .grid file
%
% organize.MPI(mipvar, varName)
%
% ----- Inputs -----
%
...
f2 = sprintf('%s_Amon_MPI-ESM-P_historical_r1i1p1_185001-200512.nc', mipvar);
